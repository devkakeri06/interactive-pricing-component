  ...
  return (
    <div className="h-screen text-center text-blue-100 dark:bg-blue-50 bg-pattern bg-no-repeat bg-10050">
      <div className="flex flex-col">
        <div className="my-8 align-middle bg-circles bg-no-repeat bg-center min-h-min flex flex-col justify-center h-100 sm:my-23">
        ...
        <div class="attribution">
          ...
          <a href="https://www.frontendmentor.io?ref=challenge" target="_blank">
            Invsto @frontendmentor
          </a>
          . Coded by{" "}
          <a href="https://github.com/devkakeri06">Devaansh Kakeri</a>.
        </div>
      </div>
    </div>
  );
